    ...
    public class GaussianCutout : MonoBehaviour
    {
        ...
        public static ShaderData GetShaderData(GaussianCutout self, Matrix4x4 rendererMatrix)
        {
            ...
            if (self && self.isActiveAndEnabled)
            {
                ...
                sd.data.y = Mathf.Tan(Mathf.Deg2Rad * self.m_Fov * 0.5f);
                sd.data.x = sd.data.y * self.m_Aspect;
        ...
        public void OnDrawGizmos()
        {
            ...
            if (m_Type == Type.Pyramid)
            {
                Gizmos.DrawFrustum(Vector3.zero, m_Fov, 5.0f, 0.0f, m_Aspect);
            }
        }
