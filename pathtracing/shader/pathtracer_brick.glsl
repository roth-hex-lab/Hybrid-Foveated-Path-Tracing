...
void main() {
    ...
    bool calculate_motion = true; // TODO: Configurable

    // trace ray
    vec4 L;
    vec2 mv = trace_path(pos, dir, seed, L, current_view_projection_matrix, prev_view_projection_matrix, resolution, first_sample, calculate_motion);
